...
import {
  ...
  c,
  i
} from "./chunk-O7ELFTAT.js";
import {
  __rest
} from "./chunk-SK3LMOYI.js";
import "./chunk-DM2QJZS7.js";
import "./chunk-PIX3PJKD.js";
import {
  __toESM
...
var ReactiveElement = class extends HTMLElement {
  ...
  _initialize() {
    ...
    this.requestUpdate();
    (_a5 = this.constructor._initializers) === null || _a5 === void 0 ? void 0 : _a5.forEach((i2) => i2(this));
  }
  /**
  ...
  connectedCallback() {
    ...
    (_a5 = this.__controllers) === null || _a5 === void 0 ? void 0 : _a5.forEach((c3) => {
      var _a6;
      return (_a6 = c3.hostConnected) === null || _a6 === void 0 ? void 0 : _a6.call(c3);
    });
  }
  /**
  ...
  disconnectedCallback() {
    ...
    (_a5 = this.__controllers) === null || _a5 === void 0 ? void 0 : _a5.forEach((c3) => {
      var _a6;
      return (_a6 = c3.hostDisconnected) === null || _a6 === void 0 ? void 0 : _a6.call(c3);
    });
  }
  /**
  ...
  performUpdate() {
    ...
    try {
      ...
      if (shouldUpdate) {
        ...
        (_b4 = this.__controllers) === null || _b4 === void 0 ? void 0 : _b4.forEach((c3) => {
          var _a6;
          return (_a6 = c3.hostUpdate) === null || _a6 === void 0 ? void 0 : _a6.call(c3);
        });
  ...
  _$didUpdate(changedProperties) {
    ...
    (_a5 = this.__controllers) === null || _a5 === void 0 ? void 0 : _a5.forEach((c3) => {
      var _a6;
      return (_a6 = c3.hostUpdated) === null || _a6 === void 0 ? void 0 : _a6.call(c3);
    });
    if (!this.hasUpdated) {
...
((_d2 = global3.litHtmlVersions) !== null && _d2 !== void 0 ? _d2 : global3.litHtmlVersions = []).push("2.7.5");
...
function getEasingForSegment(easing, i2) {
  return isEasingList(easing) ? easing[wrap2(0, easing.length, i2)] : easing;
}
...
function interpolate(output, input = defaultOffset(output.length), easing = noopReturn) {
  ...
  return (t) => {
    ...
    let progressInRange = clamp(0, 1, progress(input[i2], input[i2 + 1], t));
...
var cubicBezierAsString = ([a, b, c3, d2]) => `cubic-bezier(${a}, ${b}, ${c3}, ${d2})`;
...
function rt() {
  var e;
  const o = (e = X.state.themeMode) != null ? e : "dark", r = { light: { foreground: { 1: "rgb(20,20,20)", 2: "rgb(121,134,134)", 3: "rgb(158,169,169)" }, background: { 1: "rgb(255,255,255)", 2: "rgb(241,243,243)", 3: "rgb(228,231,231)" }, overlay: "rgba(0,0,0,0.1)" }, dark: { foreground: { 1: "rgb(228,231,231)", 2: "rgb(148,158,158)", 3: "rgb(110,119,119)" }, background: { 1: "rgb(20,20,20)", 2: "rgb(39,42,42)", 3: "rgb(59,64,64)" }, overlay: "rgba(255,255,255,0.1)" } }[o];
...
var h = { getPreset(e) {
  ...
  const e = document.querySelector(":root"), { themeVariables: o } = X.state;
  if (e) {
...
var F = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? it(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
T.styles = [h.globalCss, at], F([property({ type: Boolean })], T.prototype, "disabled", 2), F([property()], T.prototype, "iconLeft", 2), F([property()], T.prototype, "iconRight", 2), F([property()], T.prototype, "onClick", 2), F([property()], T.prototype, "variant", 2), T = F([customElement("wcm-button")], T);
...
var ue = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? st(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var wt = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? ht(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var ut = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? vt(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && gt(o, r, t), t;
};
var fe = class extends LitElement {
  render() {
    return html`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${v.WALLET_CONNECT_LOGO} <button @click="${Q.close}">${v.CROSS_ICON}</button></div>`;
  }
};
...
var yt = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? xt(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var Ot = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? kt(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && Ct(o, r, t), t;
};
...
var te = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Et(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var S = class extends LitElement {
  ...
  backBtnTemplate() {
    return html`<button class="wcm-back-btn" @click="${N.goBack}">${v.BACK_ICON}</button>`;
  }
  actionBtnTemplate() {
    return html`<button class="wcm-action-btn" @click="${this.onAction}">${this.actionIcon}</button>`;
  }
  render() {
    const e = { "wcm-border": this.border }, o = N.state.history.length > 1, r = this.title ? html`<wcm-text variant="big-bold">${this.title}</wcm-text>` : html`<slot></slot>`;
    return html`<header class="${classMap(e)}">${o ? this.backBtnTemplate() : null} ${r} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
  }
};
S.styles = [h.globalCss, Wt], te([property()], S.prototype, "title", 2), te([property()], S.prototype, "onAction", 2), te([property()], S.prototype, "actionIcon", 2), te([property({ type: Boolean })], S.prototype, "border", 2), S = te([customElement("wcm-modal-header")], S);
var c2 = { MOBILE_BREAKPOINT: 600, WCM_RECENT_WALLET_DATA: "WCM_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", getShadowRootElement(e, o) {
  const r = e.renderRoot.querySelector(o);
  if (!r)
    throw new Error(`${o} not found`);
  return r;
}, getWalletIcon({ id: e, image_id: o }) {
  const { walletImages: r } = C.state;
  return r != null && r[e] ? r[e] : o ? G.getWalletImageUrl(o) : "";
}, getWalletName(e, o = false) {
  return o ? e.split(" ")[0] : e;
}, isMobileAnimation() {
  return window.innerWidth <= c2.MOBILE_BREAKPOINT;
}, async preloadImage(e) {
  const o = new Promise((r, a) => {
    const t = new Image();
    t.onload = r, t.onerror = a, t.src = e;
  });
  return Promise.race([o, i.wait(3e3)]);
}, getErrorMessage(e) {
  ...
  const { walletConnectUri: o } = c.state, { mobile: r, name: a } = e, t = r == null ? void 0 : r.native, l = r == null ? void 0 : r.universal;
  c2.setRecentWallet(e);
  function i2(s) {
    let $2 = "";
    t ? $2 = i.formatUniversalUrl(t, s, a) : l && ($2 = i.formatNativeUrl(l, s, a)), i.openHref($2, "_self");
  }
  o && i2(o);
}, handleAndroidLinking() {
  const { walletConnectUri: e } = c.state;
  e && (i.setWalletConnectAndroidDeepLink(e), i.openHref(e, "_self"));
}, async handleUriCopy() {
  const { walletConnectUri: e } = c.state;
  if (e)
    try {
      await navigator.clipboard.writeText(e), Y.openToast("Link copied", "success");
    } catch {
      Y.openToast("Failed to copy", "error");
    }
}, getCustomImageUrls() {
  const { walletImages: e } = C.state, o = Object.values(e ?? {});
  return Object.values(o);
}, truncate(e, o = 8) {
  return e.length <= o ? e : `${e.substring(0, 4)}...${e.substring(e.length - 4)}`;
}, setRecentWallet(e) {
  try {
    localStorage.setItem(c2.WCM_RECENT_WALLET_DATA, JSON.stringify(e));
  } catch {
    console.info("Unable to set recent wallet");
  }
}, getRecentWallet() {
  try {
    const e = localStorage.getItem(c2.WCM_RECENT_WALLET_DATA);
  ...
  i.openHref(c2.EXPLORER_WALLET_URL, "_blank");
}, getCachedRouterWalletPlatforms() {
  const { desktop: e, mobile: o } = i.getWalletRouterData(), r = Boolean(e == null ? void 0 : e.native), a = Boolean(e == null ? void 0 : e.universal), t = Boolean(o == null ? void 0 : o.native) || Boolean(o == null ? void 0 : o.universal);
  return { isDesktop: r, isMobile: t, isWeb: a };
}, goToConnectingView(e) {
  N.setData({ Wallet: e });
  const o = i.isMobile(), { isDesktop: r, isWeb: a, isMobile: t } = c2.getCachedRouterWalletPlatforms();
  o ? t ? N.push("MobileConnecting") : a ? N.push("WebConnecting") : N.push("InstallWallet") : r ? N.push("DesktopConnecting") : a ? N.push("WebConnecting") : t ? N.push("MobileQrcodeConnecting") : N.push("InstallWallet");
} };
...
var $e = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Rt(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && Lt(o, r, t), t;
};
var oe = class extends LitElement {
  ...
  get routerEl() {
    return c2.getShadowRootElement(this, ".wcm-router");
  }
  get contentEl() {
    return c2.getShadowRootElement(this, ".wcm-content");
  }
  viewTemplate() {
    switch (this.view) {
      case "ConnectWallet":
  ...
  async onChangeRoute() {
    await animate2(this.routerEl, { opacity: [1, 0], scale: [1, 1.02] }, { duration: 0.15, delay: 0.1 }).finished, this.view = N.state.view, animate2(this.routerEl, { opacity: [0, 1], scale: [0.99, 1] }, { duration: 0.37, delay: 0.05 });
  }
  render() {
    return html`<div class="wcm-router"><div class="wcm-content">${this.viewTemplate()}</div></div>`;
  }
};
oe.styles = [h.globalCss, Mt], $e([state()], oe.prototype, "view", 2), $e([state()], oe.prototype, "prevView", 2), oe = $e([customElement("wcm-modal-router")], oe);
...
var ze = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Tt(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && Pt(o, r, t), t;
};
var ne = class extends LitElement {
  constructor() {
    super(), this.open = false, this.unsubscribe = void 0, this.timeout = void 0, this.unsubscribe = Y.subscribe((e) => {
      e.open ? (this.open = true, this.timeout = setTimeout(() => Y.closeToast(), 2200)) : (this.open = false, clearTimeout(this.timeout));
    });
  }
  disconnectedCallback() {
    var e;
    (e = this.unsubscribe) == null || e.call(this), clearTimeout(this.timeout), Y.closeToast();
  }
  render() {
    const { message: e, variant: o } = Y.state, r = { "wcm-success": o === "success", "wcm-error": o === "error" };
...
ne.styles = [h.globalCss, At], ze([state()], ne.prototype, "open", 2), ne = ze([customElement("wcm-modal-toast")], ne);
var jt = 0.1;
var Ve = 2.5;
var A = 7;
function Ce(e, o, r) {
...
function _t(e, o) {
  const r = Array.prototype.slice.call(import_qrcode.default.create(e, { errorCorrectionLevel: o }).modules.data, 0), a = Math.sqrt(r.length);
  return r.reduce((t, l, i2) => (i2 % a === 0 ? t.push([l]) : t[t.length - 1].push(l)) && t, []);
}
var Dt = { generate(e, o, r) {
  const a = "#141414", t = "#ffffff", l = [], i2 = _t(e, "Q"), s = o / i2.length, $2 = [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }];
  $2.forEach(({ x: y, y: u }) => {
    const O = (i2.length - A) * s * y, b = (i2.length - A) * s * u, E = 0.45;
    for (let M = 0; M < $2.length; M += 1) {
      const V = s * (A - M * 2);
      l.push(svg`<rect fill="${M % 2 === 0 ? a : t}" height="${V}" rx="${V * E}" ry="${V * E}" width="${V}" x="${O + s * M}" y="${b + s * M}">`);
    }
  });
  const f = Math.floor((r + 25) / s), Ne = i2.length / 2 - f / 2, Ze = i2.length / 2 + f / 2 - 1, Se = [];
  i2.forEach((y, u) => {
    y.forEach((O, b) => {
      if (i2[u][b] && !(u < A && b < A || u > i2.length - (A + 1) && b < A || u < A && b > i2.length - (A + 1)) && !(u > Ne && u < Ze && b > Ne && b < Ze)) {
  ...
  return Se.forEach(([y, u]) => {
    ...
    u.forEach((O) => {
      l.push(svg`<circle cx="${y}" cy="${O}" fill="${a}" r="${s / Ve}">`);
    });
    ...
    u.forEach(([O, b]) => {
      l.push(svg`<line x1="${y}" x2="${y}" y1="${O}" y2="${b}" stroke="${a}" stroke-width="${s / (Ve / 2)}" stroke-linecap="round">`);
    });
  }), l;
} };
...
var j = class extends LitElement {
  ...
  svgTemplate() {
    const e = X.state.themeMode === "light" ? this.size : this.size - 36;
    return svg`<svg height="${e}" width="${e}">${Dt.generate(this.uri, e, e / 4)}</svg>`;
  }
  render() {
    const e = { "wcm-dark": X.state.themeMode === "dark" };
...
var qt = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Ft(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var Oe = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Yt(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var _ = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Jt(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var L = class extends LitElement {
  ...
  handleClick() {
    $.click({ name: "WALLET_BUTTON", walletId: this.walletId }), this.onClick();
  }
  render() {
    var e;
    return html`<button @click="${this.handleClick.bind(this)}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${ifDefined(this.imageId)}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${(e = this.label) != null ? e : c2.getWalletName(this.name, true)}</wcm-text>${this.sublabelTemplate()}</div></button>`;
  }
};
...
var se = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? oo(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && to(o, r, t), t;
};
var Q2 = class extends LitElement {
  constructor() {
    super(...arguments), this.walletId = "", this.imageId = void 0, this.imageUrl = void 0;
  }
  render() {
    var e;
    const o = (e = this.imageUrl) != null && e.length ? this.imageUrl : c2.getWalletIcon({ id: this.walletId, image_id: this.imageId });
    return html`${o.length ? html`<div><img src="${o}" alt="${this.id}"></div>` : v.WALLET_PLACEHOLDER}`;
  }
};
Q2.styles = [h.globalCss, eo], se([property()], Q2.prototype, "walletId", 2), se([property()], Q2.prototype, "imageId", 2), se([property()], Q2.prototype, "imageUrl", 2), Q2 = se([customElement("wcm-wallet-image")], Q2);
var ro = Object.defineProperty;
var ao = Object.getOwnPropertyDescriptor;
var qe = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? ao(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var We = class extends LitElement {
  ...
  async loadImages(e) {
    try {
      e != null && e.length && await Promise.all(e.map(async (o) => c2.preloadImage(o)));
    } catch {
  ...
  async preloadListings() {
    if (C.state.enableExplorer) {
      await G.getRecomendedWallets(), c.setIsDataLoaded(true);
      const { recomendedWallets: e } = G.state, o = e.map((r) => c2.getWalletIcon(r));
      await this.loadImages(o);
    } else
      c.setIsDataLoaded(true);
  }
  async preloadCustomImages() {
    const e = c2.getCustomImageUrls();
  ...
  async preloadData() {
    try {
      ...
      console.error(e), Y.openToast("Failed preloading", "error");
    }
  }
};
...
var no = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? io(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && lo(o, r, t), t;
};
var Qe = class extends LitElement {
  constructor() {
    super(), this.unsubscribeTheme = void 0, h.setTheme(), this.unsubscribeTheme = X.subscribe(h.setTheme);
  }
  disconnectedCallback() {
    var e;
...
var ho = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? mo(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var Ie = class extends LitElement {
  ...
  render() {
    const { recomendedWallets: e } = G.state, o = [...e, ...e], r = i.RECOMMENDED_WALLET_AMOUNT * 2;
    ...
    })}</div><wcm-button-big @click="${c2.handleAndroidLinking}"><wcm-text variant="medium-regular" color="inverse">Select Wallet</wcm-text></wcm-button-big></div></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">Choose WalletConnect to see supported apps on your device</wcm-text></wcm-info-footer>`;
  }
};
...
var K = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? go(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var D = class extends LitElement {
  ...
  svgLoaderTemplate() {
    var e, o;
    const r = (o = (e = X.state.themeVariables) == null ? void 0 : e["--wcm-wallet-icon-large-border-radius"]) != null ? o : h.getPreset("--wcm-wallet-icon-large-border-radius");
    let a = 0;
    r.includes("%") ? a = 88 / 100 * parseInt(r, 10) : a = parseInt(r, 10), a *= 1.17;
    const t = 317 - a * 1.57, l = 425 - a * 1.8;
    return html`<svg viewBox="0 0 110 110" width="110" height="110"><rect id="wcm-loader" x="2" y="2" width="106" height="106" rx="${a}"/><use xlink:href="#wcm-loader" stroke-dasharray="106 ${t}" stroke-dashoffset="${l}"></use></svg>`;
  }
  render() {
...
var G2 = { manualWallets() {
  var e, o;
  const { mobileWallets: r, desktopWallets: a } = C.state, t = (e = G2.recentWallet()) == null ? void 0 : e.id, l = i.isMobile() ? r : a, i2 = l == null ? void 0 : l.filter((s) => t !== s.id);
  return (o = i.isMobile() ? i2 == null ? void 0 : i2.map(({ id: s, name: $2, links: f }) => ({ id: s, name: $2, mobile: f, links: f })) : i2 == null ? void 0 : i2.map(({ id: s, name: $2, links: f }) => ({ id: s, name: $2, desktop: f, links: f }))) != null ? o : [];
}, recentWallet() {
  return c2.getRecentWallet();
}, recomendedWallets(e = false) {
  var o;
  const r = e || (o = G2.recentWallet()) == null ? void 0 : o.id, { recomendedWallets: a } = G.state;
  return a.filter((t) => r !== t.id);
} };
var Z = { onConnecting(e) {
  c2.goToConnectingView(e);
}, manualWalletsTemplate() {
  return G2.manualWallets().map((e) => html`<wcm-wallet-button walletId="${e.id}" name="${e.name}" .onClick="${() => this.onConnecting(e)}"></wcm-wallet-button>`);
}, recomendedWalletsTemplate(e = false) {
  return G2.recomendedWallets(e).map((o) => html`<wcm-wallet-button name="${o.name}" walletId="${o.id}" imageId="${o.image_id}" .onClick="${() => this.onConnecting(o)}"></wcm-wallet-button>`);
}, recentWalletTemplate() {
  const e = G2.recentWallet();
  if (e)
...
var fo = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? bo(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && uo(o, r, t), t;
};
var Ee = class extends LitElement {
  render() {
    const { explorerExcludedWalletIds: e, enableExplorer: o } = C.state, r = e !== "ALL" && o, a = Z.manualWalletsTemplate(), t = Z.recomendedWalletsTemplate();
    let l = [Z.recentWalletTemplate(), ...a, ...t];
    l = l.filter(Boolean);
    const i2 = l.length > 4 || r;
    let s = [];
    i2 ? s = l.slice(0, 3) : s = l;
    const $2 = Boolean(s.length);
    return html`<wcm-modal-header .border="${true}" title="Connect your wallet" .onAction="${c2.handleUriCopy}" .actionIcon="${v.COPY_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-mobile-title"><div class="wcm-subtitle">${v.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">Mobile</wcm-text></div><div class="wcm-subtitle">${v.SCAN_ICON}<wcm-text variant="small-regular" color="secondary">Scan with your wallet</wcm-text></div></div><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>${$2 ? html`<wcm-modal-footer><div class="wcm-desktop-title">${v.DESKTOP_ICON}<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">${s} ${i2 ? html`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-footer>` : null}`;
  }
};
...
var Co = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? $o(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && yo(o, r, t), t;
};
var Me = class extends LitElement {
  render() {
    const { termsOfServiceUrl: e, privacyPolicyUrl: o } = C.state;
...
var Io = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Wo(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var Le = class extends LitElement {
  ...
  render() {
    ...
    let l = [Z.recentWalletTemplate(), ...a, ...t];
    l = l.filter(Boolean);
    const i2 = l.length > 8 || r;
    let s = [];
    i2 ? s = l.slice(0, 7) : s = l;
    const $2 = Boolean(s.length);
    return html`<wcm-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${v.QRCODE_ICON}"></wcm-modal-header>${$2 ? html`<wcm-modal-content><div>${s} ${i2 ? html`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-content>` : null}`;
  }
};
...
var Re = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Lo(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && Mo(o, r, t), t;
};
var ae = class extends LitElement {
  constructor() {
    super(), this.open = false, this.active = false, this.unsubscribeModal = void 0, this.abortController = void 0, this.unsubscribeModal = Q.subscribe((e) => {
  ...
  get overlayEl() {
    return c2.getShadowRootElement(this, ".wcm-overlay");
  }
  get containerEl() {
    return c2.getShadowRootElement(this, ".wcm-container");
  }
  toggleBodyScroll(e) {
  ...
  onCloseModal(e) {
    e.target === e.currentTarget && Q.close();
  }
  onOpenModalEvent() {
    this.toggleBodyScroll(false), this.addKeyboardEvents(), this.open = true, setTimeout(async () => {
      const e = c2.isMobileAnimation() ? { y: ["50vh", "0vh"] } : { scale: [0.98, 1] }, o = 0.1, r = 0.2;
  ...
  async onCloseModalEvent() {
    ...
    const e = c2.isMobileAnimation() ? { y: ["0vh", "50vh"] } : { scale: [1, 0.98] }, o = 0.2;
  ...
  addKeyboardEvents() {
    this.abortController = new AbortController(), window.addEventListener("keydown", (e) => {
      var o;
      e.key === "Escape" ? Q.close() : e.key === "Tab" && ((o = e.target) != null && o.tagName.includes("wcm-") || this.containerEl.focus());
...
var le = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Po(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var B = class extends LitElement {
  ...
  onMobile() {
    i.isMobile() ? N.replace("MobileConnecting") : N.replace("MobileQrcodeConnecting");
  }
  onDesktop() {
...
var Do = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? _o(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var Ae = class extends LitElement {
  ...
  render() {
    const { recomendedWallets: e } = G.state, o = G2.manualWallets(), r = [...e, ...o].reverse().slice(0, 4);
    return html`<button @click="${this.onClick}"><div class="wcm-icons">${r.map((a) => {
      const t = c2.getWalletIcon(a);
      if (t)
        return html`<img src="${t}">`;
      const l = c2.getWalletIcon({ id: a.id });
      return l ? html`<img src="${l}">` : v.WALLET_PLACEHOLDER;
...
var de = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? So(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && Zo(o, r, t), t;
};
var Y2 = class extends LitElement {
  constructor() {
  ...
  get overlayEl() {
    return c2.getShadowRootElement(this, ".wcm-qr-container");
  }
  render() {
...
Y2.styles = [h.globalCss, No], de([property()], Y2.prototype, "walletId", 2), de([property()], Y2.prototype, "imageId", 2), de([state()], Y2.prototype, "uri", 2), Y2 = de([customElement("wcm-walletconnect-qr")], Y2);
var Bo = Object.defineProperty;
var Uo = Object.getOwnPropertyDescriptor;
var Ho = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Uo(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && Bo(o, r, t), t;
};
var Pe = class extends LitElement {
  viewTemplate() {
    return i.isAndroid() ? html`<wcm-android-wallet-selection></wcm-android-wallet-selection>` : i.isMobile() ? html`<wcm-mobile-wallet-selection></wcm-mobile-wallet-selection>` : html`<wcm-desktop-wallet-selection></wcm-desktop-wallet-selection>`;
  }
  render() {
...
var Ke = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Fo(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var me = class extends LitElement {
  ...
  onFormatAndRedirect(e) {
    const { desktop: o, name: r } = i.getWalletRouterData(), a = o == null ? void 0 : o.native;
    if (a) {
      const t = i.formatNativeUrl(a, e, r);
      i.openHref(t, "_self");
    }
  }
  openDesktopApp() {
    const { walletConnectUri: e } = c.state, o = i.getWalletRouterData();
    c2.setRecentWallet(o), e && this.onFormatAndRedirect(e);
  }
  render() {
    const { name: e, id: o, image_id: r } = i.getWalletRouterData(), { isMobile: a, isWeb: t } = c2.getCachedRouterWalletPlatforms();
    return html`<wcm-modal-header title="${e}" .onAction="${c2.handleUriCopy}" .actionIcon="${v.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${o}" imageId="${ifDefined(r)}" label="${`Continue in ${e}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Connection can continue loading if ${e} is not installed on your device`}</wcm-text><wcm-platform-selection .isMobile="${a}" .isWeb="${t}" .isRetry="${true}"><wcm-button .onClick="${this.openDesktopApp.bind(this)}" .iconRight="${v.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
  }
};
...
var Yo = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Ko(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var Te = class extends LitElement {
  ...
  render() {
    const { name: e, id: o, image_id: r, homepage: a } = i.getWalletRouterData();
...
var Ye = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? Jo(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var he = class extends LitElement {
  ...
  onFormatAndRedirect(e, o = false) {
    const { mobile: r, name: a } = i.getWalletRouterData(), t = r == null ? void 0 : r.native, l = r == null ? void 0 : r.universal;
    if (t && !o) {
      const i2 = i.formatNativeUrl(t, e, a);
      i.openHref(i2, "_self");
    } else if (l) {
      const i2 = i.formatUniversalUrl(l, e, a);
      i.openHref(i2, "_self");
    }
  }
  openMobileApp(e = false) {
    const { walletConnectUri: o } = c.state, r = i.getWalletRouterData();
    c2.setRecentWallet(r), o && this.onFormatAndRedirect(o, e);
  }
  onGoToAppStore(e) {
    e && i.openHref(e, "_blank");
  }
  render() {
    const { name: e, id: o, image_id: r, app: a, mobile: t } = i.getWalletRouterData(), { isWeb: l } = c2.getCachedRouterWalletPlatforms(), i2 = a == null ? void 0 : a.ios, s = t == null ? void 0 : t.universal;
...
var rr = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? or(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && tr(o, r, t), t;
};
var je = class extends LitElement {
  render() {
    const { name: e, id: o, image_id: r } = i.getWalletRouterData(), { isDesktop: a, isWeb: t } = c2.getCachedRouterWalletPlatforms();
    return html`<wcm-modal-header title="${e}" .onAction="${c2.handleUriCopy}" .actionIcon="${v.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr walletId="${o}" imageId="${ifDefined(r)}"></wcm-walletconnect-qr></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Scan this QR Code with your phone's camera or inside ${e} app`}</wcm-text><wcm-platform-selection .isDesktop="${a}" .isWeb="${t}"></wcm-platform-selection></wcm-info-footer>`;
  }
};
...
var ir = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? lr(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
  return a && t && ar(o, r, t), t;
};
var _e2 = class extends LitElement {
  render() {
    return html`<wcm-modal-header title="Scan the code" .onAction="${c2.handleUriCopy}" .actionIcon="${v.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>`;
  }
};
...
var ie = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? sr(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var U = class extends LitElement {
  constructor() {
    super(...arguments), this.loading = !G.state.wallets.listings.length, this.firstFetch = !G.state.wallets.listings.length, this.search = "", this.endReached = false, this.intersectionObserver = void 0, this.searchDebounce = c2.debounce((e) => {
      e.length >= 3 ? (this.firstFetch = true, this.endReached = false, this.search = e, G.resetSearch(), this.fetchWallets()) : this.search && (this.search = "", this.endReached = this.isLastPage(), G.resetSearch());
    });
  }
  firstUpdated() {
  ...
  get placeholderEl() {
    return c2.getShadowRootElement(this, ".wcm-placeholder-block");
  }
  ...
  isLastPage() {
    const { wallets: e, search: o } = G.state, { listings: r, total: a } = this.search ? o : e;
    return a <= De || r.length >= a;
  }
  async fetchWallets() {
    var e;
    const { wallets: o, search: r } = G.state, { listings: a, total: t, page: l } = this.search ? r : o;
    if (!this.endReached && (this.firstFetch || t > De && a.length < t))
      try {
        this.loading = true;
        const i2 = (e = c.state.chains) == null ? void 0 : e.join(","), { listings: s } = await G.getWallets({ page: this.firstFetch ? 1 : l + 1, entries: De, search: this.search, version: 2, chains: i2 }), $2 = s.map((f) => c2.getWalletIcon(f));
        await Promise.all([...$2.map(async (f) => c2.preloadImage(f)), i.wait(300)]), this.endReached = this.isLastPage();
      } catch (i2) {
        console.error(i2), Y.openToast(c2.getErrorMessage(i2), "error");
      } finally {
        this.loading = false, this.firstFetch = false;
      }
  }
  onConnect(e) {
    i.isAndroid() ? c2.handleMobileLinking(e) : c2.goToConnectingView(e);
  }
  onSearchChange(e) {
  ...
  render() {
    const { wallets: e, search: o } = G.state, { listings: r } = this.search ? o : e, a = this.loading && !r.length, t = this.search.length >= 3;
    let l = Z.manualWalletsTemplate(), i2 = Z.recomendedWalletsTemplate(true);
    t && (l = l.filter(({ values: f }) => c2.caseSafeIncludes(f[0], this.search)), i2 = i2.filter(({ values: f }) => c2.caseSafeIncludes(f[0], this.search)));
    const s = !this.loading && !r.length && !i2.length, $2 = { "wcm-loading": a, "wcm-end-reached": this.endReached || !this.loading, "wcm-empty": s };
    return html`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(this)}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${classMap($2)}"><div class="wcm-grid">${a ? null : l} ${a ? null : i2} ${a ? null : r.map((f) => html`${f ? html`<wcm-wallet-button imageId="${f.image_id}" name="${f.name}" walletId="${f.id}" .onClick="${() => this.onConnect(f)}"></wcm-wallet-button>` : null}`)}</div><div class="wcm-placeholder-block">${s ? html`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>` : null} ${!s && this.loading ? html`<wcm-spinner></wcm-spinner>` : null}</div></wcm-modal-content>`;
  }
};
...
var Ge = (e, o, r, a) => {
  for (var t = a > 1 ? void 0 : a ? hr(o, r) : o, l = e.length - 1, i2; l >= 0; l--)
    (i2 = e[l]) && (t = (a ? i2(o, r, t) : i2(t)) || t);
...
var we = class extends LitElement {
  ...
  onFormatAndRedirect(e) {
    const { desktop: o, name: r } = i.getWalletRouterData(), a = o == null ? void 0 : o.universal;
    if (a) {
      const t = i.formatUniversalUrl(a, e, r);
      i.openHref(t, "_blank");
    }
  }
  openWebWallet() {
  ...
  render() {
    const { name: e, id: o, image_id: r } = i.getWalletRouterData(), { isMobile: a, isDesktop: t } = c2.getCachedRouterWalletPlatforms(), l = i.isMobile();
    return html`<wcm-modal-header title="${e}" .onAction="${c2.handleUriCopy}" .actionIcon="${v.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${o}" imageId="${ifDefined(r)}" label="${`Continue in ${e}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`${e} web app has opened in a new tab. Go there, accept the connection, and come back`}</wcm-text><wcm-platform-selection .isMobile="${a}" .isDesktop="${l ? false : t}" .isRetry="${true}"><wcm-button .onClick="${this.openWebWallet.bind(this)}" .iconRight="${v.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
  }
};
...
lit-html/development/directives/if-defined.js:
   ...
   *)
*/
//# sourceMappingURL=dist-PLJMTW7R.js.map

...
// node_modules/viem/dist/esm/chains/formatters/celo.js
var formattersCelo = {
  block: defineBlock({
...
// node_modules/viem/dist/esm/chains/formatters/optimism.js
...
// node_modules/viem/dist/esm/chains/serializers/celo.js
...
var celo2 = defineChain(celo, {
  formatters: formattersCelo,
  serializers: serializersCelo
});
var celoAlfajores2 = defineChain(celoAlfajores, {
  formatters: formattersCelo,
  serializers: serializersCelo
});
var celoCannoli2 = defineChain(celoCannoli, {
  formatters: formattersCelo,
  serializers: serializersCelo
});
...
var mev2 = defineChain(mev);
var mevTestnet2 = defineChain(mevTestnet);
...
async function getBlock(client, { blockHash, blockNumber, blockTag = "latest", includeTransactions = false } = {}) {
  ...
  const format2 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.block) == null ? void 0 : _c.format) || formatBlock;
...
async function estimateGas(client, args) {
  ...
  try {
    ...
    assertRequest(args);
    const format2 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transactionRequest) == null ? void 0 : _c.format) || formatTransactionRequest;
...
async function sendTransaction(client, args) {
  ...
  try {
    ...
    const format2 = ((_c = (_b = chain == null ? void 0 : chain.formatters) == null ? void 0 : _b.transactionRequest) == null ? void 0 : _c.format) || formatTransactionRequest;
    const request = format2({
      // Pick out extra data that might exist on the chain's transaction request type.
      ...extract(rest, { format: format2 }),
      accessList,
...
async function getTransaction(client, { blockHash, blockNumber, blockTag = "latest", hash, index: index2 }) {
  ...
  const format2 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transaction) == null ? void 0 : _c.format) || formatTransaction;
...
async function getTransactionReceipt(client, { hash }) {
  ...
  const format2 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transactionReceipt) == null ? void 0 : _c.format) || formatTransactionReceipt;
...
//# sourceMappingURL=chunk-A7MVYQRR.js.map

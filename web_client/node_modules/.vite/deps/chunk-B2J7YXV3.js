...
function hashAbiItem(def) {
  return hash2(`${def.name}(${def.inputs.map(({ type }) => type).join(",")})`);
}
...
// node_modules/viem/dist/esm/utils/formatters/formatter.js
...
async function call(client, args) {
  ...
  try {
    ...
    const { offchainLookup: offchainLookup2, offchainLookupSignature: offchainLookupSignature2 } = await import("./ccip-N6MLLASI.js");
...
*/
//# sourceMappingURL=chunk-B2J7YXV3.js.map

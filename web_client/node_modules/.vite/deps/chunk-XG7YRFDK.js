  ...
  "node_modules/@stablelib/sha256/lib/sha256.js"(exports) {
    ...
    function hashBlocks(w2, v, p, pos, len) {
      while (len >= 64) {
        ...
        for (var i = 0; i < 16; i++) {
          var j2 = pos + i * 4;
          w2[i] = binary_1.readUint32BE(p, j2);
        }
        for (var i = 16; i < 64; i++) {
          var u = w2[i - 2];
        ...
        for (var i = 0; i < 64; i++) {
          var t1 = (((e >>> 6 | e << 32 - 6) ^ (e >>> 11 | e << 32 - 11) ^ (e >>> 25 | e << 32 - 25)) + (e & f2 ^ ~e & g) | 0) + (h + (K[i] + w2[i] | 0) | 0) | 0;
...
var require_x25519 = __commonJS({
  "node_modules/@stablelib/x25519/lib/x25519.js"(exports) {
    ...
    function scalarMult(n, p) {
      ...
      const a = gf(), b2 = gf(), c = gf(), d = gf(), e = gf(), f2 = gf();
      for (let i = 0; i < 31; i++) {
        z2[i] = n[i];
      }
      z2[31] = n[31] & 127 | 64;
...
function Un(e, n) {
  const t = ue.sharedKey(fromString2(e, f), fromString2(n, f)), r = new import_hkdf.HKDF(import_sha256.SHA256, t).expand(Q);
  return toString2(r, f);
}
function _n(e) {
  const n = (0, import_sha256.hash)(fromString2(e, f));
  return toString2(n, f);
}
function $n(e) {
  const n = (0, import_sha256.hash)(fromString2(e, x));
  return toString2(n, f);
}
function Se(e) {
...
function jn(e) {
  ...
  if ($(n) === U && typeof e.senderPublicKey > "u")
    throw new Error("Missing sender public key for type 1 envelope");
  const t = typeof e.senderPublicKey < "u" ? fromString2(e.senderPublicKey, f) : void 0, r = typeof e.iv < "u" ? fromString2(e.iv, f) : (0, import_random.randomBytes)(J), o = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e.symKey, f)).seal(r, fromString2(e.message, x));
  return Ie({ type: n, sealed: o, iv: r, senderPublicKey: t });
}
function Cn(e) {
  const n = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e.symKey, f)), { sealed: t, iv: r } = Z(e.encoded), o = n.open(r, t);
  if (o === null)
...
function Z(e) {
  const n = fromString2(e, L), t = n.slice(Rn, Oe), r = Oe;
  if ($(t) === U) {
...
function Dn(e, n) {
  const t = Z(e);
  return Pe({ type: $(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? toString2(t.senderPublicKey, f) : void 0, receiverPublicKey: n == null ? void 0 : n.receiverPublicKey });
}
function Pe(e) {
  const n = (e == null ? void 0 : e.type) || Y;
  if (n === U) {
...
var Re = (e, n, t) => n in e ? Mn(e, n, { enumerable: true, configurable: true, writable: true, value: t }) : e[n] = t;
var we = (e, n) => {
  for (var t in n || (n = {}))
    kn.call(n, t) && Re(e, t, n[t]);
  if (Te)
    for (var t of Te(n))
      Kn.call(n, t) && Re(e, t, n[t]);
  return e;
...
function Ce(e, n) {
  let t = V.parse(e);
  return t = we(we({}, t), n), e = V.stringify(t), e;
}
function Fn() {
...
function Ve() {
  var e;
  const n = j();
  return n === N.browser ? [n, ((e = (0, import_window_getters.getLocation)()) == null ? void 0 : e.host) || "unknown"].join(":") : n;
}
function Me(e, n, t) {
  const r = De(), o = Ve();
...
function qn({ protocol: e, version: n, relayUrl: t, sdkVersion: r, auth: o, projectId: s, useOnCloseEvent: i }) {
  const l = t.split("?"), d = Me(e, n, r), c = { auth: o, ua: d, projectId: s, useOnCloseEvent: i || void 0 }, u = Ce(l[1] || "", c);
  return l[0] + "?" + u;
}
function O(e, n) {
...
function Xn(e = import_time.FIVE_MINUTES, n) {
...
async function ct({ id: e, topic: n, wcDeepLink: t }) {
  try {
    ...
    i === N.browser ? s.startsWith("https://") ? window.open(s, "_blank", "noreferrer noopener") : window.open(s, "_self", "noreferrer noopener") : i === N.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(s);
  } catch (r) {
    console.error(r);
  }
}
...
var He = (e, n, t) => n in e ? lt(e, n, { enumerable: true, configurable: true, writable: true, value: t }) : e[n] = t;
var pt = (e, n) => {
  for (var t in n || (n = {}))
    dt.call(n, t) && He(e, t, n[t]);
  if (Fe)
    for (var t of Fe(n))
      ft.call(n, t) && He(e, t, n[t]);
  return e;
};
function qe(e, n = "-") {
  const t = {}, r = "relay" + n;
...
function mt(e) {
  ...
  return { protocol: r, topic: ze(o[0]), version: parseInt(o[1], 10), symKey: i.symKey, relay: qe(i) };
}
function ze(e) {
...
var Be = (e, n, t) => n in e ? ht(e, n, { enumerable: true, configurable: true, writable: true, value: t }) : e[n] = t;
var bt = (e, n) => {
  for (var t in n || (n = {}))
    gt.call(n, t) && Be(e, t, n[t]);
  if (We)
    for (var t of We(n))
      Nt.call(n, t) && Be(e, t, n[t]);
  return e;
};
var Ot = (e, n) => Et(e, vt(n));
function R(e) {
  const n = [];
  return e.forEach((t) => {
    const [r, o] = t.split(":");
...
function re(e) {
  ...
  for (const [s, i] of Object.entries(e)) {
    const l = te(s) ? [s] : i.chains, d = i.methods || [], c = i.events || [], u = Ze(s);
    o[u] = Ot(bt({}, o[u]), { chains: S(l, (n = o[u]) == null ? void 0 : n.chains), methods: S(d, (t = o[u]) == null ? void 0 : t.methods), events: S(c, (r = o[u]) == null ? void 0 : r.events) });
  }
  return o;
}
...
function m(e, n) {
  return n && I(e) ? true : typeof e == "string" && !!e.trim().length;
}
function q(e, n) {
  return n && I(e) ? true : typeof e == "number" && !isNaN(e);
}
function Rt(e, n) {
...
function _t(e, n) {
  let t = null;
  return m(e == null ? void 0 : e.publicKey, false) || (t = b("MISSING_OR_INVALID", `${n} controller public key should be a string`)), t;
}
function oe(e) {
  let n = true;
  return C(e) ? e.length && (n = e.every((t) => m(t, false))) : n = false, n;
}
function en(e, n, t) {
  let r = null;
  return C(n) && n.length ? n.forEach((o) => {
    r || D(o) || (r = w("UNSUPPORTED_CHAINS", `${t}, chain ${o} should be a string and conform to "namespace:chainId" format`));
  }) : D(e) || (r = w("UNSUPPORTED_CHAINS", `${t}, chains must be defined as "namespace:chainId" e.g. "eip155:1": {...} in the namespace key OR as an array of CAIP-2 chainIds e.g. eip155: { chains: ["eip155:1", "eip155:5"] }`)), r;
}
function nn(e, n, t) {
  let r = null;
...
function rn(e, n) {
  ...
  return Object.values(e).forEach((r) => {
    if (t)
      return;
    const o = tn(r == null ? void 0 : r.accounts, `${n} namespace`);
    o && (t = o);
  }), t;
}
function on(e, n) {
  let t = null;
  return oe(e == null ? void 0 : e.methods) ? oe(e == null ? void 0 : e.events) || (t = w("UNSUPPORTED_EVENTS", `${n}, events should be an array of strings or empty array for no events`)) : t = w("UNSUPPORTED_METHODS", `${n}, methods should be an array of strings or empty array for no methods`), t;
}
function se(e, n) {
  let t = null;
  return Object.values(e).forEach((r) => {
...
function $t(e, n, t) {
  ...
  if (e && H(e)) {
    ...
    r = b("MISSING_OR_INVALID", `${n}, ${t} should be an object with data`);
  return r;
}
function sn(e, n) {
  let t = null;
  if (e && H(e)) {
    ...
    t = b("MISSING_OR_INVALID", `${n}, namespaces should be an object with data`);
  return t;
}
function cn(e) {
...
function jt(e, n) {
  let t = false;
  return n && !e ? t = true : e && C(e) && e.length && e.forEach((r) => {
    t = cn(r);
  }), t;
}
function Ct(e) {
...
function xt(e, n, t) {
  return m(t, false) ? Je(e, n).includes(t) : false;
}
function Ft(e, n, t) {
  return m(t, false) ? Qe(e, n).includes(t) : false;
}
function an(e, n, t) {
  let r = null;
  const o = Ht(e), s = qt(n), i = Object.keys(o), l = Object.keys(s), d = un(Object.keys(e)), c = un(Object.keys(n)), u = d.filter((a) => !c.includes(a));
  return u.length && (r = b("NON_CONFORMING_NAMESPACES", `${t} namespaces keys don't satisfy requiredNamespaces.
      Required: ${u.toString()}
    ...
    g.includes(a) || (r = b("NON_CONFORMING_NAMESPACES", `${t} namespaces accounts don't satisfy namespace accounts for ${a}
        Required: ${a}
        Approved: ${g.toString()}`));
  }), i.forEach((a) => {
    r || (O(o[a].methods, s[a].methods) ? O(o[a].events, s[a].events) || (r = b("NON_CONFORMING_NAMESPACES", `${t} namespaces events don't satisfy namespace events for ${a}`)) : r = b("NON_CONFORMING_NAMESPACES", `${t} namespaces methods don't satisfy namespace methods for ${a}`));
  }), r;
}
function Ht(e) {
  const n = {};
...
function zt(e, n) {
  return q(e, false) && e <= n.max && e >= n.min;
}
...
tslib/tslib.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-XG7YRFDK.js.map

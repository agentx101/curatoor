...
const NFTAddress = require("../deployments/zoragoerli/Nft.json").address; //change the directory as per deployment chain
const RegistryAddress = require("../deployments/zoragoerli/ERC6551Registry.json").address; //change the directory as per deployment chain
const ERC6551AccountAddress = require("../deployments/zoragoerli/ERC6551Account.json").address; //change the directory as per deployment chain/
...
async function main() {
    ...
    console.log("Transfering ETh to the TokenBoundAccount",NewAccountaddress);
